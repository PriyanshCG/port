...
const COMMANDS = {
    ...
    skills: {
        output: [
            { type: 'success', text: '▶ Technical Skills & Expertise [v2026]' },
            { type: 'text', text: '' },
            { type: 'category', text: '[ Languages ]' },
            { type: 'skill', text: '  ⬡ JavaScript (ES6+)  ⬡ C++' },
            { type: 'text', text: '' },
            { type: 'category', text: '[ Frameworks & Libraries ]' },
            { type: 'skill', text: '  ⬡ React.js  ⬡ React Native  ⬡ Next.js  ⬡ Tailwind CSS' },
            { type: 'text', text: '' },
            { type: 'category', text: '[ Backend & Databases ]' },
            { type: 'skill', text: '  ⬡ Node.js  ⬡ Express.js  ⬡ MongoDB  ⬡ MySQL  ⬡ Mongoose  ⬡ Redis  ⬡ REST APIs' },
            { type: 'text', text: '' },
            { type: 'category', text: '[ Tools & Platforms ]' },
            { type: 'skill', text: '  ⬡ Git  ⬡ GitHub  ⬡ Postman  ⬡ npm  ⬡ Vercel  ⬡ Netlify  ⬡ Render  ⬡ Figma  ⬡ Docker' },
            { type: 'text', text: '' },
            { type: 'category', text: '[ Core Competencies ]' },
            { type: 'skill', text: '  ⬡ Full-Stack Web Apps  ⬡ RESTful APIs  ⬡ Auth & Security (JWT, OAuth)  ⬡ Real-Time Apps  ⬡ Cloud Deployment' },
        ]
    },
    education: {
        output: [
            ...
            { type: 'text', text: '' },
            { type: 'edu', year: '2021-23', text: 'Apollo International School, Ahmedabad — Secondary Education' },
            { type: 'edu', year: '2023-25', text: "ST. Xavier's High School Loyola, Ahmedabad — Higher Secondary Education" },
            { type: 'edu', year: '2025-29', text: 'CodingGita x Swaminarayan University — B.Tech in Computer Engineering' },
            { type: 'text', text: '' },
            { type: 'info', text: '📚 Pursuing B.Tech Computer Engineering.' },
        ]
    },
    projects: {
        output: [
            ...
            { type: 'text', text: '' },
            { type: 'project', num: '01', name: 'SafeHer India', tech: 'React.js, Node.js, Express.js, MongoDB, Real-time APIs', url: 'https://github.com/PriyanshCG' },
            { type: 'project', num: '02', name: 'National Vulnerability Database', tech: 'React.js, Node.js, Express.js, MongoDB', url: 'https://github.com/PriyanshCG' },
            { type: 'project', num: '03', name: 'SkillSense AI', tech: 'React.js, Tailwind CSS, AI (SU_HACKATHON 3rd)', url: 'https://skillsense-ai-seven.vercel.app/' },
            { type: 'project', num: '04', name: 'NaturePulse', tech: 'React 19, Node.js, Express.js, MongoDB, AI/ML', url: 'https://github.com/PriyanshCG' },
            { type: 'text', text: '' },
            { type: 'info', text: '→ Type "clear" to reset | Scroll to Projects section for live demos.' },
        ]
    },
    contact: {
        output: [
            ...
            { type: 'contact', label: 'Phone   ', value: '+91 8849284972' },
            { type: 'contact', label: 'Location', value: 'Ahmedabad, Gujarat' },
            ...
            { type: 'contact', label: 'LeetCode', value: 'leetcode.com/u/priyanshhh30' },
            { type: 'text', text: '' },
