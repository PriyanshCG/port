...
const timeline = [
    {
        ...
        school: 'Apollo International School, Ahmedabad',
        desc: 'Completed secondary education building core analytical skills, mathematics, and science foundation.',
        icon: <FaSchool />,
        color: '#FFD700',
    },
    {
        ...
        school: "ST. Xavier's High School Loyola, Ahmedabad",
        desc: 'Completed higher secondary education with focus on computer science, mathematics, and core sciences.',
        icon: <FaSchool />,
        color: '#FFFACD',
    },
    {
        ...
        school: 'CodingGita x Swaminarayan University, Ahmedabad',
        desc: 'Pursuing Bachelor of Technology in Computer Engineering specializing in full-stack web development, AI platforms, and scalable SaaS architecture.',
